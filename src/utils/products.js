...
export const SliderData = [
  {
      id: 1,
      title: " For Your First Shopping",
      desc: "We worked with global brands and have created an application for you to do our shopping. Enjoy your shopping.",
      cover: sofaSlide,
  },
  {
      id: 2,
...
export const serviceData = [
  {
    ...
    title: "Free Shipping",
    subtitle: "Get FREE delivery on all orders!",
    bg: "#fdefe6",
  },
  {
    icon: <ion-icon name="card"></ion-icon>,
    title: "Safe Payment",
    subtitle: "Safe payment options are available",
    bg: "#ceebe9",
  },
  {
  ...
  },
  {
    ...
    subtitle: "Return policy is available",
    bg: "#d6e5fb",
  },
];
